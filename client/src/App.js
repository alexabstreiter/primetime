...
import LensHub
    from "./artifacts/contracts/core/LensHub.sol/LensHub.json";
                ...
                <Grid item container direction={"row"} spacing={4} justifyContent="space-between">
                    ...
                    <Grid item xs={4}>
                        <Button onClick={async () => {
                            ...
                            //let x = await (await contract.createProfile(inputStruct)).wait();
                        ...
                        <Button onClick={async () => {
                            ...
                            await (await currency.approve(Addresses['fee collect module'], 1000000000)).wait();
                        ...
                        <Grid item>
                            ...
                            >
                                <Grid item container spacing={1} direction={"row"} xs={12} alignItems="center">
                                    <Grid item>
                                        <TextField variant="outlined" name="stakingAmount" type='number' placeholder="Staking amount"/>
                                    </Grid>
                                    <Grid item>
                                        <TextField variant="outlined" name="meetingTime" placeholder="Meeting time"/>
                                    </Grid>
                                    <Grid item>
                                        <TextField variant="outlined" name="maxLateTime" placeholder="Max late time"/>
                                    </Grid>
                                    <Grid item>
                                        <TextField variant="outlined" name="meetingInformation" placeholder="Meeting information"/>
                                    </Grid>
                                    <Grid item>
